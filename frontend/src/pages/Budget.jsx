            ...
            <section className="row summary-section">
                <div className="col s4">
                    <div className="card-panel gradient-green" style={{ marginBottom: '20px' }}>
                        <h5 className="center summary-header">Total Income</h5>
                        <p className="center summary-text">${totalIncome}</p>
                    </div>
                </div>
                <div className="col s4">
                    <div className="card-panel gradient-blue" style={{ marginBottom: '20px' }}>
                        <h5 className="center summary-header">Total Expenses</h5>
                        <p className="center summary-text">${totalExpenses}</p>
                    </div>
                </div>
                <div className="col s4">
                    <div className="card-panel gradient-teal" style={{ marginBottom: '20px' }}>
                        <h5 className="center summary-header">Total Balance</h5>
                        <p className="center summary-text">${totalBalance}</p>
                    </div>
                </div>
            </section>
